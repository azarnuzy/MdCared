...
<html lang="en">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/7f67acf21c.js"
      crossorigin="anonymous"
    ></script>
  ...
  <body>
    ...
    <header class="header d-flex flex-row">
      ...
      >
        ...
        <span><a href="https://api.whatsapp.com/send?phone=6282246449106&text=Saya%20tertarik%20untuk%20membeli%20produk%20ini%20segera.">HUBUNGI KAMI</a></span>
      </div>
...
<!-- Main content -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
              <div class="section-title text-center">
                <h2>KENAPA HARUS MDCARED?</h2>
                <p>
                  Look into yourself, know you're ambitious and keep moving
                  forward until you get something in return as your achievement
                </p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
              <div
                class="why-chhose-us-box wow fadeInUp center"
                data-wow-delay="0.1s"
                style="
                  visibility: visible;
                ...
                <div class="why-chhose-us-box-inner">
                  ...
                  <div class="why-chhose-us-content">
                    ...
                    <p class="theme-description">
                      ...
                      courses and access it anytime and from anywhere
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
              ...
              >
                <div class="why-chhose-us-box-inner">
                  ...
                  <div class="why-chhose-us-content">
                    <h3 class="theme-title">Praktical Learning</h3>
                    <p class="theme-description">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
              ...
              >
                ...
                <div class="text-center">
                  <button name="submit-msg" type="submit">Send Message</button>
                </div>
              </form>
            </div>
          </div>
    ...
    <!-- End of Main -->
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li>
                  <i class="bx bx-chevron-right"></i> <a href="#">Courses</a>
                </li>
                <li>
      ...
      <div class="container footer-bottom clearfix">
        <div class="copyright">
          &copy; Copyright <strong><span>MDCared</span></strong
          >. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Web Development By
          <a href="https://bootstrapmade.com/">MuhammadAzarN</a>
        </div>
      </div>
    </footer>
    <!-- End Footer -->
